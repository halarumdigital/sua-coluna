...
async function createConversationsTable() {
  ...
  try {
    console.log('🔧 Criando tabelas de conversas WhatsApp...');
    ...
    `);
    console.log('✅ Tabela whatsapp_conversations criada');
    ...
    await connection.execute(`
      ...
      VALUES 
        (UUID(), (SELECT id FROM whatsapp_instances LIMIT 1), '5511999999999@s.whatsapp.net', '5511999999999', 'João Silva', 'Olá! Como posso ajudar?', NOW(), 0, 'active'),
        (UUID(), (SELECT id FROM whatsapp_instances LIMIT 1), '5511888888888@s.whatsapp.net', '5511888888888', 'Maria Santos', 'Obrigada pelo atendimento!', NOW(), 2, 'active'),
        (UUID(), (SELECT id FROM whatsapp_instances LIMIT 1), '5511777777777@s.whatsapp.net', '5511777777777', 'Pedro Costa', 'Preciso de informações sobre o produto', NOW(), 1, 'active')
